-- Create the screens table with all required columns
...
-- Insert sample data with diverse locations and specifications
INSERT INTO public.screens (country, city, state, organization, projection, format, dimension, screen_type, seats, screen_size, opened_date) VALUES
    ...
    ('Netherlands', 'Amsterdam', 'North Holland', 'Pathé', 'Digital IMAX', '4K', '3D', 'flat', 275, '48ft x 24ft', '2021-05-22'),
    ('Spain', 'Madrid', 'Madrid', 'Cinesa', 'Digital IMAX', '4K', '2D', 'flat', 295, '54ft x 27ft', '2020-12-08'),
    ('Italy', 'Rome', 'Lazio', 'UCI Cinemas', 'Digital IMAX', '4K', '3D', 'dome', 400, '72ft x 56ft', '2022-03-15'),
    ('Mexico', 'Mexico City', 'Mexico City', 'Cinépolis', 'Digital IMAX', '4K', '2D', 'flat', 285, '51ft x 25ft', '2021-08-30'),
    ('China', 'Shanghai', 'Shanghai', 'Wanda Cinemas', 'Digital IMAX', '4K', '3D', 'flat', 350, '62ft x 31ft', '2020-11-12'),
    ('Singapore', 'Singapore', 'Singapore', 'Golden Village', 'Digital IMAX', '4K', '2D', 'dome', 390, '68ft x 52ft', '2022-06-05'),
    ('UAE', 'Dubai', 'Dubai', 'Vox Cinemas', 'Digital IMAX', '4K', '3D', 'flat', 330, '58ft x 29ft', '2021-09-18'),
    ('South Africa', 'Johannesburg', 'Gauteng', 'Ster-Kinekor', 'Digital IMAX', '4K', '2D', 'flat', 270, '47ft x 23ft', '2020-07-25'),
    ('Sweden', 'Stockholm', 'Stockholm County', 'SF Bio', 'Digital IMAX', '4K', '3D', 'dome', 410, '74ft x 57ft', '2022-01-10'),
    ('Norway', 'Oslo', 'Oslo', 'Nordisk Film', 'Digital IMAX', '4K', '2D', 'flat', 260, '46ft x 23ft', '2021-11-28');

-- Verify the table was created successfully
SELECT 
    'Screens table created successfully' as status,
